...
class Command(BaseCommand):
    ...
    def _create_users(self):
        ...
        for data in users_data:
            user, created = self.User.objects.get_or_create(
                email=data["email"], defaults={**data, "is_active": True}
            )
            if created:
    ...
    def _create_clients(self):
        clients_data = [
            ...
            {
                "first_name": "Динара",
                "last_name": "Сагинтаева",
                "email": "dinara@halyk.kz",
                "phone": "+77022345678",
                "address": "Астана, пр. Республики 10",
            },
            {
                "first_name": "Максим",
                "last_name": "Иванов",
                "email": "maxim@kcell.kz",
                "phone": "+77033456789",
            ...
            },
            {
                "first_name": "Айша",
                "last_name": "Бекова",
                "email": "aisha@beeline.kz",
                "phone": "+77044567890",
                "address": "Шымкент, ул. Байтурсынова 3",
            },
            {
                "first_name": "Сергей",
                "last_name": "Козлов",
                "email": "sergey@aktobe.kz",
                "phone": "+77055678901",
                "address": "Актобе, ул. Маресьева 7",
            },
            {
                "first_name": "Зарина",
                "last_name": "Нурмагамбетова",
                "email": "zarina@samruk.kz",
                "phone": "+77066789012",
                "address": "Астана, ул. Кабанбай батыра 2",
            },
            {
                "first_name": "Арман",
                "last_name": "Джаксыбеков",
                "email": "arman@kegoc.kz",
                "phone": "+77077890123",
                "address": "Алматы, пр. Аль-Фараби 15",
            },
            {
                "first_name": "Ольга",
                "last_name": "Смирнова",
                "email": "olga@kazpost.kz",
                "phone": "+77088901234",
                "address": "Алматы, ул. Сейфуллина 20",
            },
        ]
    ...
    def _create_products(self):
        ...
        products_data = [
            {
                ...
                "category": software,
                "price": "99000.00",
                "description": "Годовая лицензия CRM Pro",
                "tags": [tag_vip],
            },
            {
                "name": "CRM Enterprise",
                ...
                "category": software,
                "price": "450000.00",
                "description": "Корпоративная лицензия CRM",
            ...
            },
            {
                ...
                "category": hardware,
                "price": "250000.00",
                "description": "Настройка и установка сервера",
                "tags": [tag_enterprise],
            },
            {
                "name": "Cloud Backup",
                ...
                "category": services,
                "price": "15000.00",
                "description": "Облачное резервное копирование",
                "tags": [tag_discount],
            },
            {
                "name": "IT Consulting",
            ...
            },
            {
                ...
                "category": support,
                "price": "25000.00",
                "description": "Базовый план поддержки",
                "tags": [tag_discount],
            },
            {
                ...
                "category": support,
                "price": "75000.00",
                "description": "Премиум план поддержки 24/7",
            ...
            },
            {
                ...
                "category": software,
                "price": "35000.00",
                "description": "Мобильное приложение CRM",
                "tags": [],
            },
        ]
        for data in products_data:
            ...
            product, created = Product.objects.get_or_create(
                slug=data["slug"], defaults={**data, "created_by": admin}
            )
            if created and tags:
    ...
    def _create_deals(self):
        ...
        titles = [
            ...
            "Обновление лицензии",
            "Подключение облачного бэкапа",
            "Консультация по IT",
            "Покупка оборудования",
            "Продление поддержки",
            "Новый корпоративный контракт",
            "Пилотный проект",
            "Расширение лицензии",
