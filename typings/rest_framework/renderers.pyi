...
class TemplateHTMLRenderer(BaseRenderer):
    ...
    charset = ...
    def render(self, data, accepted_media_type=..., renderer_context=...): # -> SafeText | str:
        """
    ...
    def resolve_template(self, template_names): # -> _BaseTemplate:
        ...
    ...
    def get_exception_template(self, response): # -> _BaseTemplate:
        ...
...
class HTMLFormRenderer(BaseRenderer):
    ...
    base_template = ...
    default_style = ...
    def render_field(self, field, parent_style): # -> SafeText | str:
        ...
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    def get_rendered_html_form(self, data, view, method, request): # -> SafeText | str | Literal[True] | None:
        """
    ...
    def render_form_for_serializer(self, serializer): # -> SafeText | str | None:
        ...
    ...
    def get_filter_form(self, data, view, request): # -> SafeText | str | None:
        ...
