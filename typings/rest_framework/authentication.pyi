...
class BasicAuthentication(BaseAuthentication):
    ...
    def authenticate_credentials(self, userid, password, request=...): # -> tuple[AbstractUser, None]:
        """
...
class TokenAuthentication(BaseAuthentication):
    ...
    def authenticate(self, request): # -> tuple[Any, Token] | None:
        ...
    
    def authenticate_credentials(self, key): # -> tuple[Any, Token]:
        ...
