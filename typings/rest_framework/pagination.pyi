...
class PageNumberPagination(BasePagination):
    ...
    def paginate_queryset(self, queryset, request, view=...): # -> list[Any] | None:
        """
    ...
    def get_page_number(self, request, paginator): # -> Literal[1]:
        ...
    ...
    def get_page_size(self, request): # -> int | Any | list[Any] | None:
        ...
...
class LimitOffsetPagination(BasePagination):
    ...
    def get_limit(self, request): # -> int | Any | list[Any] | None:
        ...
...
class CursorPagination(BasePagination):
    ...
    def get_ordering(self, request, queryset, view): # -> tuple[str] | tuple[str, ...]:
        """
